...
| CI | Execuções de `972d9f8`, `ed3fdc0`, `a73d344`, `175e287`, `8543089`, `1783add`, `12064f3`, `8dcb7a1` e `bb7af19` concluídas com sucesso. A última, `33945755195`, terminou no Ubuntu às `05:03:54Z` e no Windows às `05:10:12Z`. |
...
| Comparações finais | Consulta às `2026-09-05T05:35:41Z`: 17 de 38 execuções concluídas, uma ativa e 20 planejadas. Sete paridades aprovadas: os seis cenários WIOD13 `workers=1` e o cálculo completo WIOD16 `workers=1`. Dez verificações internas do oráculo WIOD13 foram coletadas; sua avaliação conjunta ainda está pendente. |
