...
| CI | Execuções de `972d9f8`, `ed3fdc0`, `a73d344`, `175e287`, `8543089` e `1783add` concluídas com sucesso. As duas últimas são `33939322479` e `33939562981`. |
...
| Execução científica real | Em `2026-09-05T03:15:26Z`, 16 dos 28 cenários passaram: quatro cálculos `workers=1` e 12 recálculos completos dos estágios 1/4/5. Quatro seletivos do estágio 4 em execução; seletivos 5 e cálculos `workers=2` pendentes. Conclusão de execução não implica paridade. |
