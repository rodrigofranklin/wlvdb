...
| CI | Execuções de `972d9f8`, `ed3fdc0`, `a73d344`, `175e287`, `8543089`, `1783add` e `12064f3` concluídas com sucesso. As três últimas são `33939322479`, `33939562981` e `33941729420`. |
...
| Execução científica real | Em `2026-09-05T03:35:29Z`, 24 dos 28 cenários passaram: todos os cálculos `workers=1`, recálculos completos dos estágios 1/4/5 e seletivos dos estágios 4/5. Um cálculo `workers=2` em execução e três planejados. Conclusão de execução não implica paridade. |
...
| Infraestrutura de desempenho | Quatro roots autenticados em C: provisionados, sem executar R. Plano serial e negativos passaram; 28 medições nativas, quatro comparações estritas de seeds, zero cálculos extras de seed. |
