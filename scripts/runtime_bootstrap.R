...
wlv_runtime_definition_manifest <- function() {
  c(
    ...
    "scripts/lib/indicator_metadata.R",
    "scripts/lib/gfcf_contracts.R",
    "scripts/lib/gfcf_diagnostics.R",
    "scripts/lib/leontief_diagnostics.R",
    "scripts/lib/wiodr16_allocation.R",
    "scripts/lib/wiodr13_validation.R",
    "scripts/lib/wiodr16_validation.R",
    "scripts/lib/scientific_validation.R",
    "scripts/lib/result_contracts.R",
    "scripts/lib/source_manifest.R",
    "scripts/lib/source_normalization.R",
    "scripts/lib/publication_manifest.R",
    "scripts/lib/publication.R",
    "scripts/lib/publication_retention.R",
    "scripts/lib/row_capital.R",
    ...
    "scripts/lib/native_data.R",
    "scripts/lib/native_registry.R",
    "scripts/lib/native_planner.R",
    "scripts/lib/native_store.R",
    "scripts/lib/runtime_snapshot.R",

    # Native source-preparation tasks and their injected production services.
    "scripts/utils/preparation_downloads.R",
    "scripts/utils/wiodr16_preparation.R",
    "scripts/lib/preparation_tasks.R",
    "scripts/preparation/native_euklems.R",
    "scripts/preparation/native_wiodr13.R",
    "scripts/preparation/native_wiodr16.R",
    "scripts/preparation/registry.R",

    # Static enforcement.
    "scripts/lib/runtime_static_analysis.R",

    # Orchestration and the public API are deliberately last.
    "scripts/lib/execution.R",
    "scripts/main.R"
  )
}
...
wlv_runtime_definition_files <- function(root = ".") {
  ...
  if (
    !base::length(relative) || base::anyNA(relative) ||
      ...
      !base::identical(relative[[base::length(relative)]], "scripts/main.R") ||
...
wlv_load_runtime <- function(root = ".") {
  ...
  bootstrap_file <- base::normalizePath(
    base::file.path(root, "scripts", "runtime_bootstrap.R"),
    winslash = "/",
    mustWork = TRUE
  )
  inventory_paths <- base::c(bootstrap_file, files)
  inventory_relative <- base::c("scripts/runtime_bootstrap.R", relative)
  captured <- wlv_bootstrap_capture_definitions(
    inventory_paths,
    inventory_relative
  )
  wlv_bootstrap_validate_loaded_identity(
    captured$bytes[["scripts/runtime_bootstrap.R"]],
