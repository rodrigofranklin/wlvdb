...
wlv_render_results_dictionary <- function(root, language = "en") {
  ...
  lines <- c(
    ...
    if (pt) "[English](results-dictionary-en.md) | [Guia em portugu\u00eas](guide-pt.md) | [Usar dados](use-results-pt.md) | [Fichas](indicator-families-pt.md)" else "[Portugu\u00eas](results-dictionary-pt.md) | [English guide](guide-en.md) | [Use data](use-results-en.md) | [Cards](indicator-families-en.md)", "",
