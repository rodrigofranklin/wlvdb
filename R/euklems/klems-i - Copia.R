...
ek.va = ek.i <- paises.setores[,c(1,2)]

ek.va$va <- left_join(paises.setores[,c(1,2)],euklems.na[which(euklems.na[,3]=="VA" & euklems.na[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]

ek.i$gfcf <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="I_GFCF" & euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]

ek.i$it <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="I_IT"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.i$ct <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="I_CT"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.i$soft <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="I_Soft_DB"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.i$traeq <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="I_TraEq"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.i$omach <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="I_OMach"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.i$ocon <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="I_OCon"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.i$rstruc <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="I_RStruc"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.i$oipp <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="I_OIPP"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.i$rd <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="I_RD"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.i$cult <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="I_Cult"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
