...
ek.k$gfcf <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="Kpyp_GFCF" & euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]

ek.k$it <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="Kpyp_IT"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.k$ct <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="Kpyp_CT"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.k$soft <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="Kpyp_Soft_DB"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.k$traeq <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="Kpyp_TraEq"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.k$omach <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="Kpyp_OMach"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.k$ocon <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="Kpyp_OCon"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.k$rstruc <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="Kpyp_RStruc"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.k$oipp <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="Kpyp_OIPP"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.k$rd <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="Kpyp_RD"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
ek.k$cult <- left_join(paises.setores[,c(1,2)],euklems[which(euklems[,3]=="Kpyp_Cult"& euklems[,7]==ano),c(1,6,8)], by = c("country", "code"))[,3]
