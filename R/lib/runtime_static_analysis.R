...
wlv_runtime_static_legacy_path <- function(value) {
  ...
  patterns <- c(
    "(^|/)r/lib/(re_)?computations[.]r($|[^a-z0-9_.-])",
    "(^|/)r/lib/(parameters|raw_sea_data|control_variables|results_variables|filters_io|prepare_computation|write_labels)[.]r($|[^a-z0-9_.-])",
    "(^|/)r/modules/(assumptions|matrices|reduced_matrices|variables)/",
