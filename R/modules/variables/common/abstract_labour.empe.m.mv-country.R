...
country_indicator <- "abstract_labour.empe.m.mv"
ratio_numerator <- sea_countries[lists$years, "abstract_labour.empe.s.mv", ]
ratio_denominator <- sea_countries[lists$years, "empe.s.un", ]
sea_countries[lists$years, country_indicator, ] <- if (
  ...
  wlv_ratio_runtime(
    ...
    stage = 5L, module = "common/abstract_labour.empe.m.mv-country.R",
