...
country_indicator <- "surplus_value.empe.r.pc"
ratio_numerator <- sea_countries[, "abstract_labour.empe.s.mv", ]
ratio_denominator <- sea_countries[, "labour_force_value.s.mv", ]
ratio_value <- if (exists("wlv_contract_runtime", inherits = FALSE)) {
  wlv_ratio_runtime(
    ...
    stage = 5L, module = "common/surplus_value.empe.r.pc-country.R",
